...
"
  (:require
   ...
   [automaton-core.log.strategy.static-ns-level :as log-static-ns-level-strategy]
...
(def stgy
  ...
  (log-static-ns-level-strategy/make-static-ns-level-strategy {:env (core-conf/read-param [:env])}))
