...
(deftest log-test
  (testing "Log expand to text-based log4j2. Meaning the strategy applied at compile time, and as expected"
    (is (= (macroexpand `(core-log/trace "Hey")) (macroexpand `(sut/log [:automaton-core.log.registry/no-op] :trace "Hey"))))
  ...
  (testing "Fatal expand to print. Meaning the strategy applied at compile time, and as expected"
    (is (= `((juxt ~automaton-core.log.impl.log4j2/log-fn) ~*ns* :fatal "Hey") (macroexpand `(core-log/fatal "Hey")))))
