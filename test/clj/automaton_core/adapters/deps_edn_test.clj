...
(deftest update-commit-id-test
  (testing "The commit id of a lib is updated when exists"
    ...
    (is (= {:deps {'foo {:git/sha "1234"}}} (sut/update-commit-id 'foo "1234" {:deps {'foo {:git/sha ""}}})))))
...
(deftest extract-deps-test
  ...
  (testing "aliases are extracted"
    (is (= [['com.clojure-goes-fast/clj-memory-meter #:mvn{:version "0.2.1"}] ['foo/bar #:mvn{:version "1.1.0"}]
