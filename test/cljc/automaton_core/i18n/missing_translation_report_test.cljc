...
(def dic-sample
  "Dictionary sample"
  {:en {:bar "anthony", :nested {:one "hey", :two "ho"}, :en-only "yep"},
   :esperanto {:bar "mati", :esp-only "yeah"}})
