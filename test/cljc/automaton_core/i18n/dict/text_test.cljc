...
(deftest dict-test
  (testing (apply str
    ...
    (is (= [] (b-language/key-with-missing-languages sut/dict core-lang/dict-core-languages-ids #{:tongue/missing-key}))))
  (testing "All languages are known languages" (is (empty? (set/difference (set (keys sut/dict)) core-lang/get-core-languages-id)))))
