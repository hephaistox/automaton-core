...
(deftest trim-leading-nil-test
  (testing "basic example"
    (is (= ["a" "b"]
           (sut/trim-leading-nil ["a" "b"])))
    (is (= ["a" "b"]
           (sut/trim-leading-nil ["a" "b" nil])))
    (is (= ["a" "b"]
           (sut/trim-leading-nil ["a" "b" nil nil nil nil])))
    (is (= [nil "a" nil nil "b"]
  ...
  (testing "Test other fn usage"
    (is (= ["a" "b"]
           (sut/trim-leading-nil ["a" "b" nil nil nil nil]
                                 nil?)))
    (is (empty? (sut/trim-leading-nil ["a" "b"]
                                      string?)))
    (is (= ["a" "b"]
           (sut/trim-leading-nil ["a" "b" nil nil "" ""]
                                 str/blank?)))))
