...
(deftest fatal-test
  (testing "Fatal is always printing something"
    (is (= "foo bar" (with-out-str (sut/log [:automaton-core.log.registry/print] :fatal "foo" "bar")))))
  (testing "Macroexpansion is resolving until the key of the chosen method"
    (is
     (= '((clojure.core/apply clojure.core/juxt (automaton-core.log.fe-log/logger-ids-to-logger-fns [:automaton-core.log.registry/print]))
